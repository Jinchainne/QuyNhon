...
export default function Page(){
  ...
  return <main className="min-h-screen bg-[#05070d] grid-bg text-slate-100 overflow-x-hidden">
    <aside className="fixed inset-y-0 left-0 w-[250px] bg-[#070b15]/95 border-r border-slate-800 p-4 overflow-y-auto z-30">
      <div className="flex items-center gap-3 mb-7"><img src="/sosovalue-logo.png" alt="SoSoValue x SoDEX" className="h-16 w-16 rounded-2xl object-cover border border-amber-400/30 shadow-3d"/><div><h1 className="text-2xl font-black leading-tight">QuyNhon AI</h1><p className="text-xs text-cyan-100/60">SoSoValue × SoDEX OS</p></div></div>
...
function JinbotCrossPanel({data,refresh,command,setCommand,secret,setSecret,send,busy,result}:any){
  ...
  return <div className="grid grid-cols-12 gap-4">
    ...
    <Card className="col-span-12 xl:col-span-4">
      ...
      <p className="text-sm text-slate-400 mb-4">Send commands to Jinbot without leaving QuyNhon AI. If JINBOT_PANEL_SECRET or ADMIN_SECRET is set, enter it below.</p>
